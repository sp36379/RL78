...
Macro definitions
***********************************************************************************************************************/
#define _02_IT8BIT_CMP00_VALUE               (0x02U) /* 8-bit interval timer compare register 00 */
#define _02_IT8BIT_CMP01_VALUE               (0x02U) /* 8-bit interval timer compare register 01 */
#define _0002_IT8BIT_CMP1_VALUE              (0x0002U) /* 16-bit interval timer compare register 1 */
